...
for (k in 1:length(true.r))
{
  for (i in 1:nsim)
  {
    print(paste0('Running ',i,'/',nsim,' of ',k,'/',length(true.r)))
    calendar.dates = replicate(n = ndates,rExponentialGrowth(a=a,b=b,r=true.r[k]))
...
save(true.r,estimated.r,estimated.90hpd.lo,estimated.90hpd.hi,file=here('R_images','experiment1_results.RData'))
